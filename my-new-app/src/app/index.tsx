...
const styles = StyleSheet.create({
  ...
  registerTextBold: { color: "#000000", fontWeight: "bold" },
  title: { fontSize: 26, fontWeight: "bold", textAlign: "center" },
  subtitle: { fontSize: 14, color: "#666666", textAlign: "center", marginBottom: 20 },
  msButton: { paddingVertical: 14, borderRadius: 10, alignItems: "center", backgroundColor: "#2f2f2f" },
  msButtonText: { color: "#ffffff", fontSize: 16, fontWeight: "600" },
  ...
  dividerText: { fontSize: 12, color: "#999999" },
  input: { borderWidth: 1, borderColor: "#cccccc", borderRadius: 8, paddingHorizontal: 14, paddingVertical: 10, fontSize: 14 },
  loginButton: { marginTop: 8, paddingVertical: 14, borderRadius: 10, alignItems: "center", backgroundColor: "#000000" },
